...
| IM-4 | `doc_id` semantics must stay stable across ingestion, retrieval, and citations. | Schema: request/evidence/response schemas (`doc_id`, scoped fields). Code: scoping + evidence assembly. Tests: strategy IM-4. |
