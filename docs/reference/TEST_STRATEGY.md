...
- `tests/fixtures/query-response.retrieval-unscoped.valid.json`
- `tests/fixtures/query-response.retrieval-scoped.valid.json`
...
| GI-2 | `tests/test_query_handler.py::QueryHandlerTests::test_unscoped_query_returns_multi_doc_evidence` | `tests/integration/test_retrieval_adapter.py::test_unscoped_no_doc_filter` | `tests/e2e/test_multidoc_queries.py::test_multidoc_default` |
| GI-3 | `tests/test_query_handler.py::QueryHandlerTests::test_same_input_returns_deterministic_response` | `tests/integration/test_evidence_builder_pipeline.py::test_repeatable_selection` | `tests/e2e/test_multidoc_queries.py::test_repeatability_on_fixed_corpus` |
...
| RI-1 | `tests/test_query_handler.py::QueryHandlerTests::test_unscoped_query_returns_multi_doc_evidence` | `tests/integration/test_retrieval_adapter.py::test_no_prefilter_in_unscoped_mode` | `tests/e2e/test_multidoc_queries.py::test_unscoped_includes_multiple_docs` |
| RI-2 | `tests/test_query_handler.py::QueryHandlerTests::test_scoped_query_filters_out_of_scope_docs` | `tests/integration/test_retrieval_adapter.py::test_scoped_filters_requested_docs_only` | `tests/e2e/test_multidoc_queries.py::test_scoped_excludes_out_of_scope_docs` |
...
| RI-4 | `tests/test_query_handler.py::QueryHandlerTests::test_zero_candidates_returns_insufficient_evidence_response` | `tests/integration/test_api_query_handler.py::test_zero_candidates_not_generation_error` | `tests/e2e/test_insufficient_evidence.py::test_stage_attribution_retrieval` |
| EI-1 | `tests/test_query_handler.py::QueryHandlerTests::test_visual_candidate_normalizes_to_schema_valid_evidence` | `tests/integration/test_evidence_builder_pipeline.py::test_unique_request_local_ids` | `tests/e2e/test_multidoc_queries.py::test_evidence_ids_present_and_unique` |
...
| AR-1 | `tests/test_query_handler.py::QueryHandlerTests::test_unscoped_query_returns_multi_doc_evidence` | `tests/test_query_server.py::QueryApiServerTests::test_handle_query_http_request_returns_retrieval_only_response` | `tests/e2e/test_multidoc_queries.py::test_response_shape_valid` |
...
| AR-3 | `tests/test_query_handler.py::QueryHandlerTests::test_scoped_query_filters_out_of_scope_docs` | `tests/integration/test_api_query_handler.py::test_scope_mode_exposed_in_meta` | `tests/e2e/test_multidoc_queries.py::test_scoped_unscoped_markers_present` |
